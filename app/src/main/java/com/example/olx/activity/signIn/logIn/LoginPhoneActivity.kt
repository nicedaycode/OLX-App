    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.verifyOtpBtn.setOnClickListener {
            ...
            if (otp.isEmpty()) {
                ...
                binding.otpEt.error = "OTP length must be 6 Numbers long"
                binding.otpEt.requestFocus()
            } else {
    ...
    private fun phoneLoginCallBacks() {
        ...
        mCallbacks = object : OnVerificationStateChangedCallbacks() {
            ...
            override fun onCodeSent(verificationId: String, token: ForceResendingToken) {
                ...
                binding.loginLabelTV.text =
                    "Please type verification code sent to $phoneNumberWithCode"
    ...
    private fun signInWithPhoneAuthCredential(credential: PhoneAuthCredential) {
        ...
        firebaseAuth.signInWithCredential(credential)
            ...
            .addOnFailureListener { e ->
                ...
                Log.d(TAG, "signInWithPhoneAuthCredential: ", e)
                progressDialog.dismiss()
